...
from modules.ServerSocket import *
...
client = ServerSocket(ip_address = "192.168.0.12",
                      port = 8765)

import threading

class client_rssi(threading.Thread):
...
while True:
    try:
        ...
        bluetooth.runner(client = client)
        # print(client.rssi)
